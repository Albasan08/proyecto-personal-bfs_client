...
/**
 * Componente que gestiona la reserva de experiencias
 * @param {Object} programacion Objeto con toda la información de la programación de la experiencia 
 * @param {Object} experiencia Objeto con toda la información de la experiencia
 * @returns Información de la reserva temporal para confirmar la reserva
 */
export const CalendarioReservasExperienciaId = ({ programacion, experiencia }) => {
    ...
    const { id } = useParams();
    const auth = getAuth();
    // Obtener email del usuario desde el usuario de google
    ...
    const handleSubmit = (event) => {
        ...
        // Hacer objeto con la información para mostrar en la siguiente pantalla y si confirma la reserva mandar al back
    ...
    return (
        <>
            <section className="formulario-reserva">
                <form className="reserva-experiencia" encType="application/x-www-form-urlencoded" onSubmit={handleSubmit}>
                    {/*Calendario*/}
